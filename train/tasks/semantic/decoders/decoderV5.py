...
class ConvBlock(nn.Module):
    def __init__(self, input_features, output_features):
        ...
        hidden_features = int(input_features * 2)
        self.block1 = CBRBlock(input_features, hidden_features, 3, 1, 1)
        self.block2 = CBRBlock(hidden_features, output_features, 1, 1, 0)
...
class DecoderBlock(nn.Module):
    def __init__(self, input_features, output_features):
        ...
        self.block2 = ConvBlock(hidden_features, hidden_features)
        self.block3 = ConvBlock(hidden_features, hidden_features)

        self.upsample = UpsampleBlock(hidden_features, output_features)
...
class LastLayer(nn.Module):
    def __init__(self, input_features, output_features):
        ...
        self.block2 = ConvBlock(hidden_features, hidden_features)
        self.block3 = ConvBlock(hidden_features, output_features)
