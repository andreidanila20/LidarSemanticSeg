...
if __name__ == '__main__':
  ...
  m_actuallyAcc = evaluator.getAccuracy()
  m_recall = evaluator.getRecall()

  print('Validation set:\n',
        'Accuracy avg {m_actuallyAcc:.3f}\n'
        'Recall avg {m_recall:.3f}\n'
        'Precision avg {m_accuracy:.3f}\n'
        'IoU avg {m_jaccard:.3f}'.format(m_actuallyAcc=m_actuallyAcc,
                                         m_recall=m_recall,
